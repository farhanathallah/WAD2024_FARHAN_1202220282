...
if (isset($_GET['delid'])) {
    $id = intval($_GET['delid']); // Mengamankan parameter dari SQL Injection
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td>
                                                            <a href='view-student.php?id={$row['nim']}'><i class='icon-eye'></i></a> ||
                                                            <a href='manage-students.php?delid={$row['nim']}' onclick=\"return confirm('Do you really want to delete?');\"><i class='icon-trash'></i></a>
                                                          </td>";
                                                    echo "</tr>";
                                                    $sno++;
                                                }
