    ...
    <div class="card-body">
        <form action="{{ route('mahasiswa.update', $mahasiswa) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_mahasiswa') is-invalid @enderror" id="nama_mahasiswa" name="nama_mahasiswa" value="{{ old('nama_mahasiswa', $mahasiswa->nama_mahasiswa) }}">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('dosen_id') is-invalid @enderror" id="dosen_id" name="dosen_id">
                    ...
                    @foreach($dosen as $d)
                        <option value="{{ $d->id }}" {{ (old('dosen_id', $mahasiswa->dosen_id) == $d->id) ? 'selected' : '' }}>
                            {{ $d->nama_dosen }}
                        </option>
                    @endforeach
                </select>
